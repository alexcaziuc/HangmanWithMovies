...
public class Game {
    ...
    /**
     * Method that replaces all the letters in the movie title with underscores, and display that instead.
     * Also replace all letters except the ones that are correctly guessed.
    ...
    public String getHiddenMovieTitle() {
        if(rightLetters.equals("")){
            // if @rightLetters is empty
            return movieToGuess.replaceAll("[a-zA-Z]", "_");
        }
        else{
            // replace anything BUT the "right letters" with "_" after @rightLetters is not empty
    ...
    /**
     * Method that returns the "right" letters that are in the movie title.
     * @return {@link String} with letters guessed that are in the movie title.
     */
    ...
    public void guessLetter() {
        ...
        if (movieToGuess.toLowerCase().contains(guessedLetter)) {
            ...
            System.out.println("That's correct! " + "\"" + rightLetters + "\"" + " letter/letters"+ " are part of the movie title.");
        }
        else {
            pointsLost++;
            wrongLetters += guessedLetter;
            System.out.println("Ooops! " + "\"" + wrongLetters + "\"" + " letter/letters"+ " are Not part of the movie title.");
        }
    }
}